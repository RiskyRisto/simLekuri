...
/**
 * Container for the state of the simulation and main part of the simulation
...
public class Surgery extends SimulationProcess {
	...
	public void run() {
		...
		try {
			...
			SimulationProcess.mainResume(); // suspend simulation entities
